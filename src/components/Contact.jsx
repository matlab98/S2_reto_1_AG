...
class Contact extends Component {
    ...
    handleSubmit(event) {
        ...
        enviarMail.setAttribute('href', `mailto:hbarrieta25@gmail.com?subject=Hola me gustaria trabajar contigo&body=${this.state.message}`)
        enviarMail.click()
    }
    ...
    render() {
        return (
            <StyledDiv>
                ...
                <a href="mailto:me@hbarrieta25@gmail.com" id="correo" style={{ display: "none" }}>link
                </a>
            </StyledDiv>
        )
    }
